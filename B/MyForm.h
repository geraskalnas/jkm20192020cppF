...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(128, 33);
			...
			this->label2->Location = System::Drawing::Point(33, 62);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(103, 173);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 5;
			this->button2->Text = L"Automobiliai";
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
	AutomobilisForma^ input = gcnew AutomobilisForma();
	input->ShowDialog();
}
};
}
